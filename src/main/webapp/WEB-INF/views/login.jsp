...
body{
 background-image: url("https://images.unsplash.com/photo-1524166104308-f17dc60c9063?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80");
 width: 1650px;
 height: 1000px;
}
