	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="row">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								...
								<a class="dropdown-item
									  "
									href="nexttest.jsp?category=호텔">호텔</a> <a class="dropdown-item"
									href="nexttest.jsp?category=쇼핑">쇼핑</a> <a class="dropdown-item"
									href="nexttest.jsp?category=카페">카페
									</a>
							</div>
						</div>
					</div>
					...
					<div class="col-md-4">
						...
						<button type="button" class="btn btn-success"
							...
							<button type= "button"  class = "btn btn-success" onclick= "location.href='cash.jsp'">cash</button>
						<button class="btn btn-primary dropdown-toggle" type="button"
				...
				<div class="recommand">
					<c:forEach items="${slist}" var="sdto" begin = "0" end = "3">
							...
							<div class="ads-line-banner-main">
								<div class="ads-line-banner-list">
									<li><img src="${sdto.images}" width=200px height=200px></li>
											<h5><a href=searchedDetail?pname=${sdto.pname}> ${sdto.pname}</a></h5>
									</div>
								</div>
							</div>
			 	</c:forEach> 
